...
export default function DashboardHeader() {
  ...
  return (
    <header className='flex h-[60px] w-full items-center justify-end border-b border-gray-d9 bg-white px-3 text-black-33 md:h-[70px] md:px-10 lg:justify-between'>
