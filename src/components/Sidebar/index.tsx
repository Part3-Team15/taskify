...
export default function Sidebar() {
  ...
  return (
    <aside className='flex min-w-16 max-w-[300px] flex-col border-r border-gray-d9 bg-white px-3 py-5 md:min-w-40 lg:min-w-72 dark:border-dark-300 dark:bg-dark'>
      <Link href={user ? '/mydashboard' : '/'} className='flex items-center justify-center pb-14 md:block md:px-3'>
        ...
        <div className='relative block size-[27px] md:hidden'>
          ...
          <Image src={'/icons/logo-white-s.svg'} alt='logo' priority className='hidden dark:block' fill />
        </div>
      </Link>
      ...
      <div className='flex grow flex-col gap-2'>
        ...
        <div className='flex flex-col gap-2'>
          <Link
            href='/mydashboard'
            className={`${activePath === '/mydashboard' ? 'bg-violet-e8 text-black-33/80 dark:bg-dark-purple dark:text-dark-10' : 'text-gray-78'} btn-violet-light dark:btn-violet-dark flex items-center justify-center rounded-md border-none py-1 md:justify-start md:px-3 md:py-2`}
          >
          ...
          <Link
            href='/mypage'
            className={`${activePath === '/mypage' ? 'bg-violet-e8 text-black-33/80 dark:bg-dark-purple dark:text-dark-10' : 'text-gray-78'} btn-violet-light dark:btn-violet-dark flex items-center justify-center rounded-md border-none py-1 md:justify-start md:px-3 md:py-2`}
          >
