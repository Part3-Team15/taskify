...
- 프로젝트 선정, 기술 스택 선정
- 요구사항 분석 후 이슈 등록
- 프로젝트 초기 설정(Git repo 생성, 각종 설정 완료)

#### 1차 기능 구현: 2024.06.21 ~ 2024.07.02

#### 추가 작업: 2024.07.02 ~ 2024.07.07

- 버그 해결, 미완성 기능 구현
- 리팩토링, 추가 기능 구현

#### 발표준비: 2024.07.06 ~ 2024.07.07
...
- 컬럼을 클릭하여 할 일 상세 정보를 확인할 수 있습니다.
...
- 대시보드 순서를 변경할 수 없어, 자주 확인하는 대시보드가 뒷쪽에 있다면 접근성이 떨어집니다.
- API 한계로 순서 변경은 어렵지만, 간단한 Next.js 서버 구현으로 즐겨찾기 기능을 추가해 접근성을 높였습니다.
- 몽고DB Atlas를 이용해서 서버를 구축했습니다. 기존 서버의 유저 정보를 받아와서 저장하고 그 정보를 바탕으로 유저마다 즐겨찾기를 추가할 수 있도록 만들었습니다.
- 즐겨찾기는 대시보드 관리 페이지에서 추가, 삭제할 수 있고 최대 3개 추가가 가능합니다.
...
- // TODO: 기술 설명을 적으려면 여기에, 간단히 적으려면 아래 디자인 개선에 내용을 추가
